...
const Login = () => {
  ...
  const sendOTP = async (method?: "sms" | "whatsapp") => {
    const otpMethod = method ?? loginMethod;
    if (method && method !== loginMethod) {
    ...
    try {
      ...
      toast({ 
        ...
        description: otpMethod === "whatsapp" ? "OTP sent via WhatsApp" : "OTP sent via SMS" 
      });
    } catch (error: any) {
          ...
          <Card className="tricolor-card overflow-hidden">
            ...
            <CardContent>
              ...
              <div className="grid grid-cols-2 gap-3">
                <Button variant="outline" type="button" className="h-14 py-0" onClick={() => sendOTP("sms")}>
                ...
                <Button variant="outline" type="button" className="h-14 py-0" onClick={() => sendOTP("whatsapp")}>
